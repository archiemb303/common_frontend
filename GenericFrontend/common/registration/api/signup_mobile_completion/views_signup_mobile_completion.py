...
from common.registration.api.signup_mobile_completion.validations_signup_mobile_complete import \
    validation_signupmobilecomplete
...
class SignUpCompletionMobileAPI(APIView):
            ...
            if profile['profile_completion_status'] == 1:
                update_params = dict(zip(['first_name', 'last_name', 'sex', 'date_of_birth', 'orientation', 'city_id',
                                         ...
                                         [input_json['first_name'], input_json['last_name'], input_json['sex'],
                                          input_json['date_of_birth'], input_json['orientation'],
